...
from transformer.leaderboard_lm import TransformerLM
...
def train(args: argparse.Namespace) -> None:
    ...
    for iteration in range(start_iter, args.max_iters):
        ...
        if args.max_seconds is not None and elapsed_time >= args.max_seconds:
            print(f"Reached time limit ({args.max_seconds}s) at iteration {iteration}")
            break
